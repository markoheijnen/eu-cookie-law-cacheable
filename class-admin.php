...
class EU_Cookie_Law_Cacheable_Admin {
	...
	public function register_setting(){
		register_setting( 'peadig_eucookie_options', 'peadig_eucookie', array( $this, 'sanitize_callback' ) );
	}
		
	
	public function add_options_page() {
		add_options_page( 'EU Cookie Law', 'EU Cookie Law', 'manage_options', 'peadig_eucookie', array( $this, 'get_options_page' ) );
	}
